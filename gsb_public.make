...
projects[gsb_public_custom_blocks][download][branch] = release-3.0
...
projects[gsb_field_formatter][download][branch] = release-3.0
...
projects[gsb_feature_base_fields][download][branch] = release-3.2
...
projects[gsb_feature_book_ct][download][branch] = release-3.1
...
projects[gsb_feature_book_display][download][branch] = release-3.0
...
projects[gsb_feature_case_ct][download][branch] = release-3.2
...
projects[gsb_feature_case_display][download][branch] = release-3.2
...
projects[gsb_feature_course_display][download][branch] = release-3.0
...
projects[gsb_feature_existing_node_fpp][download][branch] = release-3.0
...
projects[gsb_feature_faculty_ct][download][branch] = release-3.2
...
projects[gsb_feature_working_paper_ct][download][branch] = release-3.2
...
projects[gsb_feature_working_paper_display][download][branch] = release-3.2
...
projects[gsb_theme][download][branch] = release-3.2
